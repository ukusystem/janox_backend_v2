...
export const getSingleRegTickQuery = z.object({
...
export const getSingleRegTickParam = z.object({
    // rt_id: z.union([z.string(), z.number()],{errorMap: ()=>{return {message: "'rt_id' es requerido"}}}).pipe(z.coerce.number({required_error: "'rt_id' es requerido",invalid_type_error: "'rt_id' debe ser un numero xd"}).int("'rt_id' debe ser un numero entero").gte(0, "'rt_id' debe ser mayor o igual a 0"))
